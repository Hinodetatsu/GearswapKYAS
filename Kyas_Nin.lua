...
function init_gear_sets()
	...
	sets.precast.JA['Provoke'] = {ammo="",
		head="",neck="",ear1="Friomisi Earring",ear2="",
		body="",hands="Nilas Gloves",ring1="Petrov Ring",ring2="Cacoethic Ring",
		back="Fravashi Cape",waist="Goading Belt",legs="",feet=""}
	...
	sets.precast.Waltz = {ammo="",
		head="Skormoth mask",neck="Sanctity necklace",ear1="",ear2="",
		body="Hachiya Chainmail +1",hands="Herculean Gloves",ring1="Gelatinous Ring",ring2="Petrov Ring",
		back="Solemnity Cape",waist="Chaac Belt",legs="Ryou Hakama",feet="Mummu Gamashes +1"}
		
	-- Don't need any special gear for Healing Waltz.
	sets.precast.Waltz['Healing Waltz'] = {}
	
    -- Set for acc on steps, since Yonin can drop acc
	sets.precast.Step = {ammo="",
		head="Skormoth mask",neck="Sanctity necklace",ear1="Qwati Earring",ear2="Cessance Earring",
		body="Hachiya Chainmail +3",hands="Adhemar Wristbands +1",ring1="Cacoethic Ring",ring2="Regal Ring",
		back="Andartia's mantle",waist="Olseni Belt",legs="Hachiya Hakama +3",feet="Mummu Gamashes +1"}
	...
	sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, {ammo="Impatiens",neck="Mag oraga Beads",body="Mochizuki Chainmail +1",back="",feet="Hattori Kyahan"})
	...
	sets.midcast.FastRecast = {
		...
		back="",waist="Hurch'lan Sash",legs="Arjuna Breeches",feet=""}
	...
	sets.midcast.Ninjutsu = {ammo="Yamarang",
		...
		back="",waist="Eschan Stone",legs="Mummu Kecks +2",feet="Hachiya Kyahan +3"}
	
	-- Any ninjutsu cast on self - Recast Time Focus
	sets.midcast.SelfNinjutsu = set_combine(sets.midcast.Ninjutsu, {ammo="Sapience Orb",
		head="",neck="Orunmila's Torque",ear1="Loquacious Earring",ear2="Etiolation Earring",
		body="",hands="Leyline Gloves",ring1="Kishar Ring",ring2="Weatherspoon Ring",
		back="",waist="Hurch'lan Sash",legs="Arjuna Breeches",})
	
	-- FC Needs for capped recasts on Utsusemi assuming capped magical haste
	-- Ichi 52	w/Shigi 	36
	-- Ni 	58						48
	-- San	62						56
	sets.midcast.Utsusemi = set_combine(sets.midcast.SelfNinjutsu, {ammo="Impatiens",back="",feet="Hattori Kyahan"})
	
	-- Needs 68 FC for capped recast with capped magical haste.
	sets.midcast.Migawari = set_combine(sets.midcast.SelfNinjutsu, {body="", back=""})
	...
	sets.midcast.ElementalNinjutsu = {ammo="Pemphredo Tathlum",
		...
		back="",waist="",legs="",feet="Hachiya Kyahan +3",}
	...
	sets.idle = {ammo="Seki Shuriken",
		...
		body="Hizamaru Haramaki +2",hands="",ring1="Defending Ring",ring2="Paguroidea Ring",
	...
	sets.defense.PDT = {ammo="Staunch Tathlum",
		head="Blistering Sallet +1",neck="Loricate Torque +1",ear1="Colossus's Earring",ear2="",
		body="Qaaxo Harness",hands="Herculean Gloves",ring1="Gelatinous Ring",ring2="Patricius Ring",
		back="Solemnity Cape",waist="Flume Belt",legs="Ryuo Hakama",feet="Amm Greaves"}

	-- 37% MDT + Absorb + Nullification
    sets.defense.MDT = {ammo="Sihirik",
		head="Skormoth Mask",neck="Loricate Torque +1",ear1="Domin. Earring +1",ear2="Dominance Earring",
		body="Kendatsuba Samue +1",hands="Umuthi Gloves",ring1="Fortified Ring",ring2="Dark Ring",
		back="Engulfer Cape +1",waist="Flume Belt",legs="",feet="Mummu Gamash. +1"}
		
	sets.MEva = {ammo="Sihirik",
		head="Herculean Helm",neck="",ear1="Dominance Earring",ear2="Domin. Earring +1",
		body="Kendatsuba Samue +1",hands="Leyline Gloves",ring1="Fortified Ring",ring2="Dark Ring",
		back="Mubvum. Mantle",waist="",legs="Ryou Hakama",feet="Mummu Gamash. +1"}
	...
	sets.engaged = {ammo="Happo Shuriken",
		head="Hattori Zukin +1",neck="Sanctity Necklace",ear1="Brutal Earring",ear2="Cessance Earring",
		body="Mochi. Chainmail +1",hands="Floral Gauntlets",ring1="Petrov Ring",ring2="Epona's Ring",
		back="Aethling mantle",waist="Shetal Stone",legs="Mochizuki Hakama +1",feet="Hiza. Sune-Ate +1"}
	...
	sets.engaged.Multi = set_combine(sets.engaged, {ammo="Ginsen",
		...
		body="Kendatsuba Samue +1",hands="",ring1="Epona's Ring",ring2="Hetairoi Ring",
		back="Andartia's mantle",waist="Windbuffet Belt +1",legs="Samnuha Tights",feet=""})
		
	-- Acc Tier 1: 1200/1175 (Heishi/Ochu|Kikoku/Ochu) :: Acc 1240/1203 (Heishi/Shigi|Kikoku/Shigi)
	-- DW Total in Gear: 37 DW
	sets.engaged.Acc = set_combine(sets.engaged, {ring1="Enlivened Ring",ring2="Cacoethic Ring"})
	...
	sets.engaged.MaxHaste = {ammo="Happo Shuriken",
		head="Skormoth Mask",neck="Ej Necklace",ear1="Cessance Earring",ear2="Tripudio Earring",
		body="Kendatsuba Samue +1",hands="Adhemar Wristbands +1",ring1="Ilabrat Ring",ring2="Epona's Ring",
		back="Andartia's mantle",waist="Windbuffet Belt",legs="Ryou Hakama",feet="Herculean Boots"}
	...
	sets.engaged.Acc.MaxHaste = set_combine(sets.engaged.MaxHaste, {ammo="Happo Shuriken", neck="Sanctity Nodowa",ear1="Cessance Earring",})
	...
	sets.engaged.Acc2.MaxHaste = set_combine(sets.engaged.Acc.MaxHaste, {body="Adhemar Jacket",})
	
	-- Acc 1211/1188 (Heishi/Ochu|Kikoku/Ochu)) :: Acc 1252/1208 (Heishi/Shigi|Kikoku/Shigi) :: Acc ??? (Heishi/Kanaria)
	-- DW Total in Gear: 5 DW / 1 DW Needed to Cap Delay Reduction
	sets.engaged.Acc3.MaxHaste = set_combine(sets.engaged.Acc2.MaxHaste, {neck="Ej Necklace",hands="Herculean Gloves",ring2="Ramuh Ring +1",waist="Olseni Belt",legs="Hizamaru Hizayoroi +2"})
	...
	-- DW Total in Gear: 12 DW / 12 DW Needed to Cap Delay Reduction
	sets.engaged.Acc.Haste_35 = set_combine(sets.engaged.Acc.MaxHaste, {body="Adhemar Jacket",ear1="Brutal Earring",})
	...
	sets.engaged.Haste_30 = {ammo="Happo Shuriken",
		head="Hattori Zukin +1",neck="",ear1="Cessance Earring",ear2="Tripudio Earring",
		body="Adhemar Jacket",hands="Herculean Gloves",ring1="Petrov Ring",ring2="Epona's Ring",
		back="Andartia's Mantle",waist="Shetal Stone",legs="Ryuo Hakama",feet="Mummu's Gamash. +1"}
	...
	sets.engaged.Haste_15 = {ammo="Happo Shuriken",
		head="Hattori Zukin +1",neck="Ej Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
		body="Adhemar Jacket",hands="Herculean Gloves",ring1="Petrov Ring",ring2="Epona's Ring",
		back="Andartia's mantle",waist="Shetal Stone",legs="Mochizuki Hakama +1",feet="Hizamaru Sune-Ate +1"}
	...
	-- DW Total in Gear: 32 DW / 32 DW Needed to Cap Delay Reduction
	sets.engaged.Acc.Haste_15 = set_combine(sets.engaged.Haste_15, {neck="Yarak Torque"})
	...
	sets.precast.WS = {ammo="Happo Shuriken",
		head="Hachiya Hatsuburi +3",neck="Sanctity Necklace",ear1="Brutal Earring",ear2="Cessance Earring",
	...
	sets.precast.WS['Blade: Hi'] = set_combine(sets.precast.WS, {ammo="Yetshila",
		...
		back="",waist="Windbuffet Belt +1",legs="Kendatsuba Hakama",feet=""})
	...
	sets.precast.WS['Blade: Ten'] = set_combine(sets.precast.WS, {ammo="Seething Bomblet +1",
		head="Hachiya Hatsuburi +3",neck="Yarak Necklace",ear1="Tripudio Earring",ear2="Cessance Earring",
		body="Adhemar Jacket",hands="Herculean Gloves",ring1="Rajas Ring",ring2="Ilabrat Ring",
		back="Buquwik Cape",waist="Sentry Belt",legs="Ryou Hakama",feet="Herculean Boots"})
	sets.precast.WS['Blade: Ku'] = set_combine(sets.precast.WS['Blade: Shun'], {})
	sets.precast.WS['Blade: Jin'] = set_combine(sets.precast.WS, {ammo="Jukukik Feather",ring1="Rajas Ring",back="Andartia's Mantle"})
	...
	sets.precast.WS['Blade: Metsu'] = set_combine(sets.precast.WS['Blade: Ten'], {ammo="Jukukik Feather",
		...
		body="",hands="",ring1="Regal Ring",ring2="Ilabrat Ring",
		back="Andartia's mantle",waist="Fotia Belt",legs="Jokushu Haidate",feet=""})
	sets.precast.WS['Blade: Metsu'].Acc = set_combine(sets.precast.WS['Blade: Metsu'], {waist="Fotia Belt"})
	
	sets.precast.WS['Blade: Shun'] = set_combine(sets.precast.WS, {ammo="Happo Shuriken",
		head="Herculean Helm",neck="Sanctity Necklace",ear1="Kuwunga Earring", ear2="Cessance Earring",
		body="Adhemar Jacket",hands="Herculean Gloves",ring1="Cacoethic Ring",ring2="Ilabrat Ring",
		back="Aethling Mantle",waist="Light Belt", legs="Ryuo Hakama", feet="Herculean Boots"})
	
	sets.precast.WS['Blade: Yu'] = {ammo="Pemphredo Tathlum",
    head="",neck="Sanctity Necklace",ear1="Friomisi Earring",ear2="Hecate's Earring",
    body="Samnuha Coat",hands="Leyline Gloves",ring1="Dingir Ring",ring2="Shiva Ring",
	...
	sets.precast.WS['Blade: Chi'] = set_combine(sets.precast.WS, {
		...
		body="",hands="Adhemar Wristbands +1",ring1="Regal Ring",ring2="Hetairoi Ring",
		waist="Fotia Belt",legs="Hiza. Hizayoroi +2",feet=""})
